...
with st.container():
    ...
    city = st.selectbox('Select the City (Start Typing to Search)',['Cairo', 'Lagos', 'Capetown', 'Dhaka', 'Beijing',
 'Shanghai', 'Hong Kong', 'Mumbai', 'Kolkata', 'Chennai', 'Delhi', 'Jakarta',
 'Osaka', 'Tokyo', 'Kuala Lumpur', 'Katmandu', 'Islamabad', 'Karachi',
 'Singapore', 'Seoul', 'Colombo', 'Taipei', 'Bangkok',
