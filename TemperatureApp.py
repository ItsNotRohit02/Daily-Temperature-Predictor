...
st.set_page_config(page_title="Temperature Predictor", page_icon=":high_brightness:")
...
with st.container():
    ...
    cmdict = {1: 'Jan', 2: 'Feb', 3: 'March', 4: 'April', 5: 'May', 6: 'June', 7: 'July', 8: 'Aug', 9: 'Sep', 10: 'Oct',
              11: 'Nov', 12: 'Dec'}
...
with st.container():
    ...
    with c1:
        city = st.selectbox('Select the City (Start Typing to Search)',
                            ['Delhi', 'Mumbai', 'Chennai', 'Kolkata', 'London',
                             'Los Angeles', 'New York City', 'Las Vegas',
                             'Singapore', 'Paris',
                             'Cairo', 'Lagos', 'Capetown', 'Dhaka', 'Beijing',
                             'Shanghai', 'Hong Kong', 'Jakarta',
                             'Osaka', 'Tokyo', 'Kuala Lumpur', 'Katmandu',
                             'Islamabad', 'Karachi',
                             'Seoul', 'Colombo', 'Taipei', 'Bangkok',
                             'Canberra', 'Melbourne', 'Sydney', 'Vienna',
                             'Brussels', 'Prague',
                             'Athens', 'Budapest', 'Reykjavik', 'Dublin',
                             'Milan', 'Rome', 'Amsterdam',
                             'Moscow', 'Barcelona', 'Madrid',
                             'Stockholm', 'Geneva', 'Zurich', 'Kiev', 'Belfast',
                             'Tel Aviv',
                             ...
                             'Philadelphia', 'Pittsburgh', 'Memphis',
                             'Nashville', 'Austin',
                             'Houston', 'Salt Lake City', 'Seattle'])
        citydict = {'Cairo': 0, 'Nairobi': 1, 'Lagos': 2, 'Freetown': 3, 'Capetown': 4, 'Dhaka': 5, 'Beijing': 6,
                    'Shanghai': 7, 'Hong Kong': 8, 'Mumbai': 9, 'Kolkata': 10, 'Chennai': 11, 'Delhi': 12,
                    'Jakarta': 13,
                    'Osaka': 14, 'Tokyo': 15, 'Kuala Lumpur': 16, 'Katmandu': 17, 'Islamabad': 18, 'Karachi': 19,
                    'Manila': 20,
                    'Singapore': 21, 'Seoul': 22, 'Colombo': 23, 'Taipei': 24, 'Bangkok': 25, 'Hanoi': 26,
                    'Brisbane': 27,
                    'Canberra': 28, 'Melbourne': 29, 'Perth': 30, 'Sydney': 31, 'Vienna': 32, 'Brussels': 33,
                    'Prague': 34,
                    'Copenhagen': 35, 'Helsinki': 36, 'Paris': 37, 'Bordeaux': 38, 'Frankfurt': 39, 'Munich': 40,
                    'Tbilisi': 41,
                    'Athens': 42, 'Budapest': 43, 'Reykjavik': 44, 'Dublin': 45, 'Milan': 46, 'Rome': 47,
                    'Amsterdam': 48,
                    'Oslo': 49, 'Warsaw': 50, 'Lisbon': 51, 'Bucharest': 52, 'Moscow': 53, 'Barcelona': 54,
                    'Madrid': 55,
                    'Stockholm': 56, 'Bern': 57, 'Geneva': 58, 'Zurich': 59, 'Kiev': 60, 'Belfast': 61, 'London': 62,
                    'Tel Aviv': 63,
                    'Kuwait': 64, 'Beirut': 65, 'Muscat': 66, 'Doha': 67, 'Riyadh': 68, 'Ankara': 69, 'Istanbul': 70,
                    'Abu Dhabi': 71, 'Dubai': 72, 'Calgary': 73, 'Edmonton': 74, 'Halifax': 75, 'Montreal': 76,
                    'Ottawa': 77,
                    ...
                    'Baltimore': 120, 'Boston': 121, 'Detroit': 122, 'Minneapolis': 123, 'Kansas City': 124,
                    'Omaha': 125,
                    'Reno': 126,
                    ...
                    'Philadelphia': 137, 'Pittsburgh': 138, 'Rhode Island': 139, 'Memphis': 140, 'Nashville': 141,
                    'Austin': 142,
                    'Houston': 143, 'Salt Lake City': 144, 'Seattle': 145, 'Milwaukee': 146,
                    'San Juan (Puerto Rico)': 147}
        c = citydict[city]
        month = st.select_slider('Select Month',
                                 ['Jan', 'Feb', 'March', 'April', 'May', 'June', 'July', 'Aug', 'Sep', 'Oct', 'Nov',
                                  'Dec'],
                                 value=cm)
        monthdict = {'Jan': 1, 'Feb': 2, 'March': 3, 'April': 4, 'May': 5, 'June': 6, 'July': 7, 'Aug': 8, 'Sep': 9,
                     'Oct': 10, 'Nov': 11, 'Dec': 12}
        m = monthdict[month]
        d = st.slider('Select Day', 1, 31, value=currentday)
        y = today.year
    with c2:
        load_icon = load_lottieurl("https://assets10.lottiefiles.com/private_files/lf30_jmgekfqg.json")
